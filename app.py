...
<div class="main-header">
    ...
    <p>Tác giả: Dương Doãn Vũ - Trường Tiểu học Vĩ Thượng - ĐT: 0964 064 118</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dương Doãn Vũ - Trường Tiểu học Vĩ Thượng - ĐT: 0964064118</div>", unsafe_allow_html=True)
